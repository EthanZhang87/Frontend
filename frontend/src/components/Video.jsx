      ...
      <div className="px-4 mx-auto text-white sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center px-10 text-center md:px-28 lg:py-24 " >
            <div className="text-3xl font-bold text-[#3d4561] sm:text-4xl bg-gradient-to-r from-[#3d4561] via-[#4f63a0] to-[#3d4561] inline-block text-transparent bg-clip-text " data-aos='fade-up' data-aos-duration="500">
